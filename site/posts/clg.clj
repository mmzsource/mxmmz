...
(defn body []
  [:body
   ...
   (html/ul [(html/a "https://pragprog.com/titles/roclojure/" "Getting Clojure ")
   ...
   (html/ul [(html/a "https://www.manning.com/books/clojure-the-essential-reference" "Clojure, The Essential Reference")
